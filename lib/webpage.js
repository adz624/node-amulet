...
module.exports = (function () {
  ...
  WebPage.prototype.viewportSize = function (obj, cb) {
    ...
    case 2:
      if (typeof obj !== 'object') {
        cb(new Error('obj should be an object'));
      }
  ...
  WebPage.prototype.zoomFactor = function (number, cb) {
    ...
    case 2:
      if (typeof number !== 'number') {
        cb(new Error('number should be an number'));
      }
  ...
  WebPage.prototype.open = function (url, cb) {
    if (typeof url !== 'string') {
      return cb(new Error('url should be a string'));
    }
  ...
  WebPage.prototype.evaluateJavascript = function (str, cb) {
    if (typeof str !== 'string') {
      return cb(new Error('str should be a string'));
    }
  ...
  WebPage.prototype.render = function (filename, cb) {
    ...
    if (ext.indexOf(path.extname(filename).slice(1).toLocaleLowerCase()) === -1) {
